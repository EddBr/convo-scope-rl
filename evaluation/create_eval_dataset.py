...
dataset = datasets.load_from_disk("/home/s2289391/convo-plan-SCOPE/magicoder")["train"]
...
magicoder_dataset_100 = dataset.select(range(l-100, l))
...
magicoder_dataset_100.save_to_disk("magicoder_eval_100")
