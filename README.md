Fork of https://github.com/chenzhiliang94/convo-plan-SCOPE

Create embeddings in train/embed_dataset.py

Create judgement rewards on raw data in judge/data-maker.py

Merge judgement rewards with embeddings in judge/emb+rewards.py
